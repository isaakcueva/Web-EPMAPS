...
namespace GUIPagos_PSA.API_Notificaciones {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="API_GestionNotificacionesSoap", Namespace="http://tempuri.org/")]
    public partial class API_GestionNotificaciones : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public API_GestionNotificaciones() {
            this.Url = global::GUIPagos_PSA.Properties.Settings.Default.GUIPagos_PSA_API_Notificaciones_API_GestionNotificaciones;
        ...
        public Notificacion[] ListarPorEstado(bool estado) {
        ...
        public Notificacion leerPorId(int id) {
        ...
        public void Insertar(Notificacion quejas) {
            this.Invoke("Insertar", new object[] {
                        quejas});
        }
        
        /// <remarks/>
        public void InsertarAsync(Notificacion quejas) {
            this.InsertarAsync(quejas, null);
        }
        
        /// <remarks/>
        public void InsertarAsync(Notificacion quejas, object userState) {
            ...
            this.InvokeAsync("Insertar", new object[] {
                        quejas}, this.InsertarOperationCompleted, userState);
        }
        ...
        public void Actualizar(Notificacion quejas) {
            this.Invoke("Actualizar", new object[] {
                        quejas});
        }
        
        /// <remarks/>
        public void ActualizarAsync(Notificacion quejas) {
            this.ActualizarAsync(quejas, null);
        }
        
        /// <remarks/>
        public void ActualizarAsync(Notificacion quejas, object userState) {
            ...
            this.InvokeAsync("Actualizar", new object[] {
                        quejas}, this.ActualizarOperationCompleted, userState);
        }
