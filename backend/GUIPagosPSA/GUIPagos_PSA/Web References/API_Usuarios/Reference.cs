...
namespace GUIPagos_PSA.API_Usuarios {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="API_GestionUsuariosSoap", Namespace="http://tempuri.org/")]
    public partial class API_GestionUsuarios : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public API_GestionUsuarios() {
            this.Url = global::GUIPagos_PSA.Properties.Settings.Default.GUIPagos_PSA_API_Usuarios_API_GestionUsuarios;
        ...
        public Usuarios leerPorId(string cedula) {
        ...
        /// <remarks/>
        public void leerPorIdAsync(string cedula) {
            this.leerPorIdAsync(cedula, null);
        }
        
        /// <remarks/>
        public void leerPorIdAsync(string cedula, object userState) {
            ...
            this.InvokeAsync("leerPorId", new object[] {
                        cedula}, this.leerPorIdOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void InsertarAsync(Usuarios usuario) {
            this.InsertarAsync(usuario, null);
        }
        
        /// <remarks/>
        public void InsertarAsync(Usuarios usuario, object userState) {
            ...
            this.InvokeAsync("Insertar", new object[] {
                        usuario}, this.InsertarOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void ActualizarAsync(Usuarios usuario) {
            this.ActualizarAsync(usuario, null);
        }
        
        /// <remarks/>
        public void ActualizarAsync(Usuarios usuario, object userState) {
            ...
            this.InvokeAsync("Actualizar", new object[] {
                        usuario}, this.ActualizarOperationCompleted, userState);
        }
